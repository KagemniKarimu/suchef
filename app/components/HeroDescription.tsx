...
export default function HeroDescription() {
  return (
    ...
    >
      ...
      designed to bring a rich, prosocial, tutor-like experience to the practice
      of{" "}
      <span className="font-semibold bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text text-transparent">
        digitally assisted cooking
      </span>
      . Elevating your kitchen experience with{" "}
      <span className="font-semibold text-orange-500">AI insights</span>, just
      like <span className="font-mono text-pink-500">sudo</span> elevates
      privileges.
    </motion.p>
  );
}

    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-100">Add New Recipe 🍳</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-300 mb-1">Recipe Name</label>
              <input
                type="text"
                required
                value={formData.name}
                  ...
                  {commonFoodEmojis.map((emoji) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        const picker = document.querySelector('.absolute.top-full') as HTMLElement
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1">Cooking Time</label>
              <input
                type="text"
                required
